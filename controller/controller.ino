...
// which has additional links.
      ...
      //uint32_t* fl = reinterpret_cast<uint32_t*>(&pitch);

      //uint32_t value = *fl;

      int16_t value = pitch * 100.0;

/*
      byte b_0 = (value & 0b11111111000000000000000000000000) >> 24;
      byte b_1 = (value & 0b00000000111111110000000000000000) >> 16;
      byte b_2 = (value & 0b00000000000000001111111100000000) >> 8;
      byte b_3 = (value & 0b00000000000000000000000011111111) >> 0;

      
      
      Serial2.write(b_0 & 0b11110000);
      Serial2.write(b_0 & 0b00001111);

      Serial2.write(b_1 & 0b11110000);
      Serial2.write(b_1 & 0b00001111);

      Serial2.write(b_2 & 0b11110000);
      Serial2.write(b_2 & 0b00001111);

      Serial2.write(b_3 & 0b11110000);
      Serial2.write(b_3 & 0b00001111);

      */

      byte b_0 = (value & 0b1111111100000000) >> 8;
      byte b_1 = (value & 0b0000000011111111) >> 0;
