...
namespace Voxeland.Generators.Struct
{
    public class BigTree :Struct
    {
        ...
        public BigTree(int x, int y, int z, byte variation, Block[] world) : base(world)
        {
            ...
            {
                    case 1:
                        leaves = BlockIDs.LeavesOrange;
                        break;
                    case 2:
                        leaves = BlockIDs.LeavesYellow;
                        break;
                    case 3:
                        leaves = BlockIDs.LeavesGreen;
                        break;
                    default:
                        leaves = BlockIDs.Leaves;
                        break;
            }
            
            for (var yy = 0; yy < height; yy++)
            {
                if (y + yy > WorldGenerator.ChunkHeight - 1)
                {
                    continue;
                }
                    ...
                    for (var zzz = -1 + yyy; zzz <= 1 - yyy; zzz++)
                    {
                        ...
                        */
                        ...
                        _world[
                            ...
                            leaves;
                            */
                        AddBlock(x+xxx,y+yyy,z+zzz, leaves);
                    }
                }
            }
        }
